...
export async function writeChangelog (src: string) {
    ...
    const commit = 'https://github.com/RocketLeagueMapmaking/RL-Dummy-Classes/tree/5792da090da1951ceec8ed6a71ff3acd6c4eda45'

    const content = LocalClassesInstallation.createChangelog(diff, {
        description: `Changes between an installation with [dummy classes](${commit}) and autogenerated dummy classes (${process.env.VERSION})`
    })
