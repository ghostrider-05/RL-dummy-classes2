...
struct PsyNetService_OnlineStatusUpdate_X {};
struct PsyNetService_Party_X {};
struct PsyNetService_PartyChat_X {};
struct PsyNetService_PartyJoinRequestAccepted_X {};
struct PsyNetService_PartyJoinRequestDeleted_X {};
struct PsyNetService_PartyJoinRequestReceived_X {};
...
struct PsyNetService_SignedPartyChat_X {};
...
struct RPC_GetClubDetailsArray_X {};
struct RPC_GetClubInvites_X {};
struct RPC_GetClubPrivateMatches_X {};
struct RPC_GetClubStats_X {};
struct RPC_GetClubTitles_X {};
...
struct RPC_PartyAcceptJoinRequest_X {};
...
struct RPC_PartySendJoinRequest_X {};
