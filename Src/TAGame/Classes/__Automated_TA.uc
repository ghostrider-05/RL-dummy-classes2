...
struct CartInfo {};
struct ContentAuthorizationTokenInterface {};
...
struct PartyMessage_UserChatReportingLevel_TA {};
...
struct PsyNetService_ClubsMemberUpdate_TA {};
struct PsyNetService_ClubsOwnerChanged_TA {};
struct PsyNetService_ClubsRewardsReceived_TA {};
...
struct RPC_DebugUpdateClubStats_TA {};
...
struct RPC_ReportTextChatChannel_TA {};
...
struct StatusObserver_OnlineMatchEnded_TA {};
...
struct StatusTrigger_OnlineMatchEnded_TA {};
...
struct PsyNetService_ContentAuthorizationTokenRequest_TA {};
struct RPC_ClaimDLC_TA {};
struct RPC_CommunityNews_TA {};
struct RPC_NewsSendInteractionEvents_TA {};
