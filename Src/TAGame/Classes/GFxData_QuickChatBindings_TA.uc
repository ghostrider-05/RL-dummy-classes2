...
defaultproperties
{
	...
	QuickChats(17)=Group1Message18
	QuickChats(18)=Group1Message19
	QuickChats(19)=Group1Message20
	QuickChats(20)=Group1Message21
	QuickChats(21)=Group1Message22
	QuickChats(22)=Group2Message1
	QuickChats(23)=Group2Message2
	QuickChats(24)=Group2Message3
	QuickChats(25)=Group2Message4
	QuickChats(26)=Group2Message5
	QuickChats(27)=Group2Message6
	QuickChats(28)=Group2Message7
	QuickChats(29)=Group2Message8
	QuickChats(30)=Group2Message9
	QuickChats(31)=Group2Message10
	QuickChats(32)=Group2Message11
	QuickChats(33)=Group3Message1
	QuickChats(34)=Group3Message2
	QuickChats(35)=Group3Message3
	QuickChats(36)=Group3Message4
	QuickChats(37)=Group3Message5
	QuickChats(38)=Group3Message6
	QuickChats(39)=Group3Message7
	QuickChats(40)=Group3Message8
	QuickChats(41)=Group3Message9
	QuickChats(42)=Group3Message10
	QuickChats(43)=Group3Message11
	QuickChats(44)=Group3Message12
	QuickChats(45)=Group3Message13
	QuickChats(46)=Group3Message14
	QuickChats(47)=Group3Message15
	QuickChats(48)=Group3Message16
	QuickChats(49)=Group3Message17
	QuickChats(50)=Group3Message18
	QuickChats(51)=Group4Message1
	QuickChats(52)=Group4Message2
	QuickChats(53)=Group4Message3
	QuickChats(54)=Group4Message4
	QuickChats(55)=Group4Message5
	QuickChats(56)=Group4Message6
	QuickChats(57)=Group4Message7
	QuickChats(58)=Group4Message8
	QuickChats(59)=Group6Message4
